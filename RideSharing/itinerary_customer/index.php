				...
				<div class="list-group">
					<!-- Start: list_row -->
						...
						foreach ( $res as $value ) {
							if ($value->{'status'} == 1) {
								?>
								<a href="detail_itinerary.php?itinerary_id=<?php echo $value->{'itinerary_id'} ?>&driver=<?php echo $value->{'fullname'} ?>&driverid=<?php echo $value->{'user_id'} ?>" class="list-group-item">
