...
?>
<title><?php echo $lang['ITINERARY']?></title>

<!-- Section -->
<section class="full-content">
	<div class="row">
		<h4 style="text-align: center;"><?php echo $lang['LIST_SCHEDULE']?></h1>
	</div>
	<div class="row">
				...
				<div class="list-group">
					<!-- Start: list_row -->
						...
						foreach ( $res as $value ) {
							if ($value->{'status'} == 3) {
								?>
								<a href="reject_itinerary.php?itinerary_id=<?php echo $value->{'itinerary_id'} ?>&driver=<?php echo $value->{'fullname'} ?>" class="list-group-item">
